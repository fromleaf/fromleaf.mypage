...
def get_current_page_info(view_class, current_member_info):
    ...
    elif view_class.__class__.__name__ in ['DarlyView']:
        current_page_info = get_object_or_404(PlayingPage, page_container=current_page_container)
    elif view_class.__class__.__name__ in ['OurHockeyView', 'MemberListView',
                                           'GameScheduleListView',  
                                           'SelectTodayAttendListView', 'SelectedTodayAttendListView', 
