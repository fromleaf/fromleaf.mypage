...
class MySkillPageTestCase(TestCase):
    ...
    def insert_myskill(self, current_name, current_kind, current_level,
                       current_describe, current_myskill_page):
        current_myskill_set = SkillSet.objects.create(
                                    name=current_name,
                                    kind=current_kind,
                                    level=current_level,
    ...
    def insert_cooperation_skill_data(self, current_myskill_page):
        self.insert_myskill(
                            'SVN', 'COOPERATION',
                             3, 
                             '지금까지 대부분의 프로젝트의 형상관리를 SVN으로 진행하였습니다.',
                             current_myskill_page
                            )
        self.insert_myskill(
                            'Git', 'COOPERATION',
                             2, 
                             '기본적인 명령어의 사용 및 형상관리는 할 수 있는 수준입니다.',
                             current_myskill_page
                            )
        self.insert_myskill(
                            'Redmine', 'COOPERATION',
                             3, 
                             'Redmine에서 제공하는 기본 기능을 이용해서 이슈를 정리하고, 남길 수 있습니다.'
    ...
    def insert_os_skill_data(self, current_myskill_page):
        self.insert_myskill(
                            'Ubuntu', 'OS',
                             2, 
                             '필요한 경우 패키지를 설치하고, 필요한 경우 사용자 환경을 변경하여,'
        ...
        self.insert_myskill(
                            'Mac', 'OS',
                             2, 
                             '현재 사용중인 OS입니다. 개발환경을 꾸리고, Mac에서 개발하고 있습니다.',
                             current_myskill_page
                            )
    ...
    def insert_personality_skill_data(self, current_myskill_page): 
        self.insert_myskill(
                            'Positive', 'PERSONALITY',
                             4, 
                             '굉장히 긍정적입니다. 왠만한 일(도리에 어긋나지 않는 일)에는 화를 내지 않습니다.'
        ...
        self.insert_myskill(
                            'Activity', 'PERSONALITY',
                             2, 
                             '활발합니다. 긍적적인 영향 떄문일수도 있겠지만, 활발한 편이라 생각됩니다.'
                             +'그러나 항상 그렇지는 않습니다.',
                             current_myskill_page
                            )
        self.insert_myskill(
                            'Teamwork', 'PERSONALITY',
                             3, 
                             '함께 설계하고, 부족한 것을 채워주는 개발 과정을 좋아합니다.'
