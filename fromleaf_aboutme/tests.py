...
class AboutMePageTestCase(TestCase):
    ...
    def insert_simple_comment(self, input_title, input_comment, input_page):
        simple_comment = SimpleComment.objects.create(
                                                    title=input_title, 
                                                    comment=input_comment,
                                                    aboutme_page=input_page
                                                )
        simple_comment.save()
    ...
    def insert_simple_comment_data(self):
        ...
        self.insert_simple_comment(
                          '안녕하세요. 간단한 제 소개글입니다.',
                          '안녕하세요. 지금 Python을 공부하고 있으며, 이 언어를 이용한 Django Framework를 이용해 웹 개발을 공부하고 있습니다. '
